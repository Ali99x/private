...
'university1': [
    ...
    'university7': [
        ...
        { department: 'قانون', grade: 62, fee: 0 },
        { department: 'علاقات دولية', grade: 57, fee: 0 },
        { department: 'اللغة الإنكليزية', grade: 57, fee: 0 },
    ...
    'university8': [
        ...
        { department: 'هندسة مساح وجيوماتكس', grade: 72, fee: 0 },
        { department: 'هندسة نفط', grade: 74, fee: 0 },
        { department: 'هندسة ميكاترونكس', grade: 72, fee: 0 },
        { department: 'هندسة طيران', grade: 72, fee: 0 },
        { department: 'هندسة بيتروكيماويات', grade: 72, fee: 0 },
        { department: 'تقنيات المعلومات أي تي', grade: 57, fee: 0 },
        { department: 'تحليلات مرضية', grade: 59, fee: 0 },
        { department: 'علاج طبيعي', grade: 55, fee: 0 },
        { department: 'قانون', grade: 62, fee: 0 },
        { department: 'علاقات دولية', grade: 57, fee: 0 },
        { department: 'تربية إنكليزي', grade: 57, fee: 0 },
        { department: 'تربية رياضيات', grade: 57, fee: 0 },
        { department: 'تربية فيزياء', grade: 57, fee: 0 },
        { department: 'تربية احياء', grade: 59, fee: 0 },
        { department: 'تربية كومبيوتر', grade: 55, fee: 0 },
        { department: 'تربية كوردي', grade: 57, fee: 0 },
        { department: 'إدارة اعمال', grade: 55, fee: 0 },
        { department: 'محاسبة', grade: 55, fee: 0 },
        { department: 'مالية وبنوك', grade: 55, fee: 0 },
        { department: 'سياحة', grade: 55, fee: 0 },
        { department: 'تسويق وعمل', grade: 55, fee: 0 }
    ],
    'university9': [
        { department: 'هندسة معماري', grade: 77, fee: 0 },
        { department: 'هندسة مدني', grade: 77, fee: 0 },
